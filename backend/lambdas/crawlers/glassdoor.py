...
rot. Glassdoor is heavily JS-rendered and frequently changes its DOM,
making manual selectors extremely fragile. JobSpy handles all of this
internally.
...
def handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    """
    Crawl Glassdoor for jobs using JobSpy and send to SQS queue for enrichment.
    """
